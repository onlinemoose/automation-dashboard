...
FIELDS = (
    ...
    Field(
        ...
        "Additional context",
        widget="textarea",
        help="Optional. One-off context for this run — company notes, answers to "
        "application questions, a bio. Not saved; reusable text belongs under "
        "Documents. Added as one more background document for this run.",
    ),
    Field(
        "max_words",
        "Max words",
